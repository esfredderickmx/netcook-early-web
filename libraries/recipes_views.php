<?php
  ...
  class VistaRecetaInicio extends BaseDeDatos{
      ...
      if($resultado -> num_rows === 1){
        ...
        <div class="gris-800 text-light py-5">
          <main class="container">
            <p class="text-end fw-bold">¿Te equivocaste?<a href="../libraries/session_index.php" class="link-light fst-italic text-decoration-none"> ¡Vuelve a la página de inicio!</a></p>
            <div>
